...
import controlador.PrgListaSimple;
 ...
 * @author Franklin
 */
public class WinListaSimple extends javax.swing.JInternalFrame {
    
    PrgListaSimple refPrgListaSimple;
    
    public WinListaSimple() {
        initComponents();
        refPrgListaSimple = new PrgListaSimple();
        
        refPrgListaSimple.inicializarListaSimple();
        refPrgListaSimple.mostrar(txaIngre);
        refPrgListaSimple.mostrar(txaElim);
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        refPrgListaSimple.eliminarXcodigo(cod);
    ...
    private void btnGuardarIngreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarIngreActionPerformed
        ...
        refPrgListaSimple.insertar(cod, nom, sue);
