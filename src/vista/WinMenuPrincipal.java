...
public class WinMenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuItListaSimple.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuItListaSimpleActionPerformed(evt);
            }
        });
    ...
    private void menuItListaSimpleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItListaSimpleActionPerformed
        escritorio.add(refWinListaSimple);
        refWinListaSimple.setVisible(true);
    }//GEN-LAST:event_menuItListaSimpleActionPerformed
    ...
    private void menuItArregloUniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItArregloUniActionPerformed
        escritorio.add(refWinArreglosUni);
        refWinArreglosUni.setVisible(true);
